    ...
    <Nav>
      <NavContainer>
        ...
        {user && (
          ...
          {/* Accessibility handled by UserWay widget. The inline fake button was removed.
              To re-enable the external UserWay widget, add the provided snippet into
              `index.html` (before the closing </body>) or provide your UserWay account
              snippet here and I will paste it. */}
      </NavContainer>
    </Nav>
  );
}
